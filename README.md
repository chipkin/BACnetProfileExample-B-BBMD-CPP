...
[v1.1.0](https://github.com/chipkin/BACnetProfileExample-B-BBMD-CPP/releases/tag/v1.1.0)
(`metrics-windows.json` / `metrics-linux.json`):

<!-- METRICS -->
| Platform | Binary | Size | Start-up to `ready` | Stack commit |
|---|---|---|---|---|
| Windows x64 (windows-2022) | `BACnetExampleBBBMD.exe` | 3,255,808 bytes (~3.1 MiB) | 69 ms | `abd4cee1` |
| Linux x64 (ubuntu-latest) | `BACnetExampleBBBMD` | 44,352 bytes (~43 KiB) | 108 ms | `abd4cee1` |

v1.1.0 was published from a prebuilt STATIC stack library rather than the
